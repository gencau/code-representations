...
class TokenizationUtils:
    ...
    PROFILE_NAME_TO_PROVIDER_AND_MODEL = {
        ...
        "qwen3-8b-16k": {"model_provider": "meta", "model_name": "qwen3", "context_size": 16384},
        ...
        "qwen2.5-coder-32b-16k": {"model_provider": "meta", "model_name": "qwen2.5-coder", "context_size": 16384},
        ...
        "openhands-32b-16k": {"model_provider": "meta", "model_name": "openhands", "context_size": 16384},
    }
    ...
    def _decode(self, tokens: Sequence[int]) -> List[str]:
        """Estimates the number of tokens for a given string."""
        if self._model_provider in ("openai", "meta", "anthropic"):
